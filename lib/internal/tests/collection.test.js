...
describe("collection", () => {
  ...
  describe("map", () => {
    ...
    it("should find index of an element", () => {
      ...
      expect(coll.indexOf(5)).toEqual(4);
      expect(coll.indexOf(7)).toEqual(-1);
    });
    it("should find last index of an element", () => {
      const coll = Collection(
        new Map([
          ["one", 1],
          ["two", 2]
      ...
      expect(coll.lastIndexOf(5)).toEqual(-1);
      expect(coll.lastIndexOf(4)).toEqual(4);
    });
  });
