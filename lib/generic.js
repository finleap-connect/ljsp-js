import { isEmpty, isEqual, isFunction, isNumber, isObject, isString } from "lodash";
...
// Pasthrough of lodash's isEmpty - including for completeness with `notEmpty`.
export { isEmpty };
...
export function diff(a, b) {
  // prettier-ignore
  return iff(
    isObject(a), () => Array.isArray(a) ? getArrayDiff(a, b) : getObjectDiff(a, b),
