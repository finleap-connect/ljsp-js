...
describe("find", () => {
  ...
  it("should throw if provided an invalid type for array index", () => {
    expect(() => find(["a", 1, "hello", true], "2")).toThrow();
  });
  it("should throw if provided an invalid type for object index", () => {
    expect(() => find({ a: 1 }, 2)).toThrow();
  });
});
